...
### 技术总监
岗位职责：
1. 负责项目全面技术管理工作，组织并监督项目计划和进度的审核和推进工作
...
任职要求：
1. 本科及以上学历，4年以上Java开发经验，2年以上项目管理经验
1. 扎实的计算机理论基础, 良好的面向对象分析与设计能力
1. 具有极强的沟通和协调能力，愿意接受挑战和承担压力
1. 良好的代码规范和文档写作能力
1. 精通Java，Maven，数据库。熟悉分布式系统（Hadoop，ZooKeeper，redis）等。[本条改成其他语言栈]
...
任职要求：
1. 本科及以上学历，5年以上C++开发经验，2年以上项目管理经验[本条改成其他语言栈]
1. 扎实的计算机理论基础, 良好的面向对象分析与设计能力
1. 具有极强的沟通和协调能力，愿意接受挑战和承担压力
1. 良好的代码规范和文档写作能力
1. 精通C++，数据库
...
1. 具有深厚的专业技术基础，精通Java EE相关技术，熟悉Spring, JPA，Hibernate等开源框架，熟悉Linux操作系统使用[本条改成其他语言栈]
...
岗位职责：
1. 负责系统的实现
1. 参与业务分析、系统功能设计、系统数据库设计、核心代码开发和单元测试，指导软件工程师开发
1. 参与业务需求讨论会议，了解业务需求
...
### 资深软件工程师
岗位职责：
1. 负责C/C++开发规范和标准和技术选型；负责C/C++基础设施、研发框架等
1. 负责C/C++通用库和公共模块的开发和维护
1. 参与关键技术攻关，提供解决方案

任职要求：
1. 本科及以上学历，计算机相关专业
1. 5年以上C/C++经验；精通C/C++、STL；精通常见数据结构和算法
1. 精通操作系统原理和实现机制，包括Linux和Windows
1. 精通服务器开发，并行计算
1. 熟悉C/C++客户端QT开发
...
### 高级软件工程师(医学影像)
岗位职责：
1. 对影像系统进行需求分析，对应用功能进行详细设计和开发
1. 开发及维护医学影像后处理工作站客户端，开发医学影像三维可视化组件和医学影像渲染引擎
1. 及时分析并解决从客户现场反馈回来的问题

任职要求：
1. 2年以上影像研发经验；计算机科学、图像处理、软件工程、生物医学工程、电子工程等相关专业本科及以上学历
1. 熟悉c++，stl，boost，了解c++11，14等现代c++编程，熟悉面向对象软件开发，熟悉设计模式，熟悉多线程程序开发
1. 具有扎实的计算机图形学和图像处理基础理论知识
1. 熟悉QT，MFC等框架, 熟悉Windows消息机制和工作原理
1. 熟悉数据库操作, 具有Mysql, SQL Server, SQL Lite等数据库操作经验
1. 具有医学图像处理软件开发经验优先
1. 具有OpenGL/DirectX/OpenCV编程能力, 熟悉VTK等图形框架者优先
1. 具有跟硬件设备交互开发经验者优先

### 高级软件工程师(算法服务)
岗位职责：
1. 负责研发和维护C/C++的AI算法框架
1. 负责算法通用库研发和维护
