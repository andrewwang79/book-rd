...
### 高级软件工程师(医学影像)
岗位职责：
1. 对影像可视化系统进行需求分析，对应用功能进行详细设计和开发
1. 开发医学影像处理软件，开发医学影像三维可视化组件和医学影像渲染引擎
1. 及时分析并解决从客户现场反馈回来的问题

任职要求：
1. 2年以上影像可视化研发经验；计算机科学、图像处理、软件工程、生物医学工程、电子工程等相关专业本科及以上学历
1. 具有扎实的计算机图形学和图像处理基础理论知识
1. 精通OpenGL/DirectX/OpenCV/VTK等
1. 熟悉c++，stl，boost，了解c++11等现代c++编程，熟悉面向对象软件开发，熟悉设计模式，熟悉多线程、网络通信
1. 熟悉QT，MFC等框架, 熟悉Windows消息机制和工作原理
1. 具有医学影像处理软件开发经验优先，具有硬件设备交互开发经验者优先

### 中级QT工程师
岗位职责：
1. 对QT客户端进行需求分析，对应用功能进行详细设计和开发
1. 开发医学影像处理软件的QT客户端、客户端通用组件和通用库，对接服务端API
1. 及时分析并解决从客户现场反馈回来的问题

任职要求：
1. 2年以上QT研发经验；计算机科学、软件工程等相关专业本科及以上学历
1. 精通Qt应用程序图形界面开发，熟练掌握Qt控件和布局
1. 熟悉QT，MFC等框架, 熟悉Windows消息机制和工作原理
1. 熟悉c++，stl，boost，了解c++11等现代c++编程，熟悉面向对象软件开发，熟悉设计模式，熟悉多线程、网络通信
1. 具有医学影像处理软件开发经验优先，具有硬件设备交互开发经验者优先
